...
extern std::string pltype_name[PLTYPE_MAX];
std::string pltype_name[PLTYPE_MAX] = {
N_("Custom Character"), N_("Random Character"), N_("Template Character")};

extern std::string pltype_desc[PLTYPE_MAX];
std::string pltype_desc[PLTYPE_MAX] = { N_("\
...
extern trait traits[NUM_TRAITS];
