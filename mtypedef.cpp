...
mon(_("cougar"),	species_mammal, 'C',	c_dkgray,	MS_MEDIUM,	FLESH,
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
...
mon(_("fresh zombie"),species_zombie, 'Z',	c_ltred,	MS_MEDIUM,	FLESH,
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	...
	&mdeath::normal,	&mattack::upgrade, _("\
...
// This is a _("dormant") fungaloid that doesn't waste CPU cycles ;)
mon(_("fungaloid"),species_fungus, 'F',	c_ltgray,	MS_MEDIUM,	VEGGY,
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
...
// This _("dog") is, in fact, a disguised Thing
...
mon(_("shadow"),	species_nether,'S',	c_dkgray,	MS_TINY,	MNULL,
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
...
// The hub
mon(_("breather"),	species_nether,'O',	c_pink,		MS_MEDIUM,	MNULL,
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
