...
void dis_effect(game *g, player &p, disease &dis)
{
 ...
 case DI_COLD_HEAD:
  switch (dis.intensity) {
   case 3 : p.int_cur -= 3; if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your thoughts are unclear."));
   case 2 : p.int_cur--;
   case 1 : if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("\"Brr.\""));
  }
  break;

 case DI_COLD_TORSO:
  switch (dis.intensity) {
   case 3 : p.dex_cur -= 2; if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your torso is burning up. You should remove some layers."));
   // Speed -20
   case 2 :	p.dex_cur -= 1;
   // Speed -5
   case 1 : p.dex_cur -= 1; if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("\"Brr.\""));
   // Speed -2
  }
  break;
 ...
 case DI_COLD_ARMS:
  switch (dis.intensity) {
   case 3 : p.dex_cur -= 2;
   case 2 :	p.dex_cur--;
   case 1 : if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("Your arms are shivering."));
  }
  break;
 ...
 case DI_COLD_LEGS:
  switch (dis.intensity) {
   case 3 :	p.str_cur--; if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your legs are seizing from the incredible cold."));
   // Speed -20
   case 2 :	p.str_cur--;
   // Speed -5
   case 1 : if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("Your legs feel sluggish from the cold."));
   // Speed -2
  }
  break;
 ...
 case DI_FROSTBITE_HANDS:
  switch (dis.intensity) {
   ...
   case 1 :
    ...
    if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your hands feel numb."));
  }
 break;
 ...
 case DI_FROSTBITE_FEET:
  switch (dis.intensity) {
   ...
   case 1 :
    if (p.temp_cur[bp_mouth] > BODYTEMP_COLD && p.pain < 40) p.pain++;
	if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your feet feel numb."));
  }
 break;
 ...
 case DI_FROSTBITE_MOUTH:
  switch (dis.intensity) {
   ...
   case 1 :
    if (p.temp_cur[bp_mouth] > BODYTEMP_COLD && p.pain < 40) p.pain++;
	if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your face feels numb."));
  }
 break;
 ...
 case DI_HOT_HEAD:
  switch (dis.intensity) {
   ...
   case 2 :
    ...
    // Speed -5
   case 1 :
    if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("\"Phew, it's hot.\""));
    // Speed -2
  }
  break;
 ...
 case DI_HOT_TORSO:
  switch (dis.intensity) {
   case 3 :
    p.thirst--;
    p.str_cur--;
    if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("You are sweating profusely."));
    // Speed -20
   case 2 :
    p.thirst--;
	p.str_cur--;
 ...
 case DI_HOT_ARMS:
  switch (dis.intensity) {
   case 3 : p.thirst--;
    if (p.pain < 50) p.pain++;
   case 2 : p.thirst--;
   case 1 : if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("\"Phew, it's hot.\""));
  }
  break;
 ...
 case DI_HOT_LEGS:
  switch (dis.intensity) {
   case 3 : p.thirst--;
    if (p.pain < 50) p.pain++;
    if (one_in(200)) g->add_msg(_("Your legs are cramping up."));
   case 2 : p.thirst--;
   case 1 : if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("\"Phew, it's hot.\""));
  }
  break;
 ...
 case DI_HOT_FEET:
  switch (dis.intensity) {
   ...
   case 2 :
    if (p.pain < 30) p.pain++;
    if (!p.has_disease(DI_SLEEP) && one_in(200)) g->add_msg(_("Your feet are swelling in the heat."));
   case 1 : if (!p.has_disease(DI_SLEEP) && one_in(600)) g->add_msg(_("\"Phew, it's hot.\""));
  }
  break;
...
std::string dis_description(disease dis)
{
 ...
 case DI_COLD_EYES:
  switch (dis.intensity) {
   case 1: return _("Your eyes are exposed to the cold.");
   case 2: return _("Your eyes are very exposed to the cold.");
   case 3: return _("Your eyes are dangerously cold.");}

 case DI_COLD_MOUTH:
  switch (dis.intensity) {
   case 1: return _("Your mouth is exposed to the cold.");
   case 2: return _("Your mouth is very exposed to the cold.");
   case 3: return _("Your mouth is dangerously cold.");}
 ...
 case DI_COLD_ARMS:
  switch (dis.intensity) {
   ...
   case 3: return _("Your arms is dangerously cold. Your arms are shivering uncontrollably");}
 ...
 case DI_COLD_HANDS:
  switch (dis.intensity) {
   ...
   case 3: return _("Your hands is dangerously cold. Your hands are shivering uncontrollably");}
 ...
 case DI_COLD_LEGS:
  switch (dis.intensity) {
   ...
   case 3: return _("Your legs is dangerously cold. Your strength is sapped.");}
 ...
 case DI_COLD_FEET:
  switch (dis.intensity) {
   ...
   case 3: return _("Your feet is dangerously cold. Your strength is sapped.");}
 ...
 case DI_HOT_FEET:
  switch (dis.intensity) {
   case 1: return _("Your feet feel hot.");
