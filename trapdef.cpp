...
//      Name                    Symbol  Colour          Vis Avd Diff
 TRAP(_("cot"),                    '#',    c_green,         0,  0,  0,
        &trapfunc::none,         &trapfuncm::cot,
        itm_cot, NULL);

//      Name                    Symbol  Colour          Vis Avd Diff
 TRAP(_("brazier"),                '#',    c_red,           0,  0,  0,
        &trapfunc::none,         &trapfuncm::none,
        itm_brazier, NULL);

//      Name                    Symbol  Colour          Vis Avd Diff
 TRAP(_("roll mat"),               '#',    c_blue,          0,  0,  0,
        &trapfunc::none,     &trapfuncm::none,
        itm_rollmat, NULL);
//	Name			Symbol	Color		Vis Avd Diff
